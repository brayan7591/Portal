    ...
    @if ($instructores->count())
        <div class="table-responsive mt-2">
            ...
            <tbody>
                ...
                <tr>
                        <th scope="row" class="align-middle">{{$instructor->id}}</th>
                        <td class="align-middle">{{$instructor->nombre}}</td>
                        <td class="align-middle">{{$instructor->programa->NombrePrograma}}</td>
                        <td class="options">
        ...
        @endif
    @else
        <h1>No hay instructores Destacados por el momento :(</h1>
    @endif
</div>
