    ...
    @if ($voceros->count())
        <div class="table-responsive mt-2">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row" class="align-middle">{{$vocero->id}}</th>
                    <td class="align-middle">{{$vocero->nombre}}</td>
                    <td class="align-middle">{{$vocero->programa->NombrePrograma}}</td>
                    <td class="options">
        ...
        @endif
    @else
        <h1>No hay voceros Destacados por el momento :(</h1>
    @endif
</div>
