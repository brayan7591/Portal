...
class ProgramaSeeder extends Seeder
{
    ...
    public function run()
    {
        programa::create([
            ...
            'imagen' => "imagenes/programas/" . Faker::create()->image('public/storage/imagenes/programas', 1000, 400, 'programa', false),
        ...
        programa::create([
            ...
            'slug' => 'Cocina',
            'imagen' => "imagenes/programas/" . Faker::create()->image('public/storage/imagenes/programas', 1000, 400, null, false),
